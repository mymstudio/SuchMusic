<template>
    <n-config-provider :theme-overrides="themeOverrides">
        <div class="bottom">
            ...
            <div
                style="position: absolute; top: -3px; left: 17.2%; background-color: transparent; width: 60vw;  height: 6px;">
                <span
                    style="position: absolute; top:-9px; left: 27.5%; background-color: transparent; width: 35vw;  height: 6px;">{{
                ...
                <span
                    style="position: absolute; top:-9px; left: 70%; background-color: transparent; width: 35vw;  height: 6px;">{{
                        formatTime(audioStore.duration) }}</span>
            </div>
            ...
            <div class="bottom-left">
                <n-dropdown trigger="hover" :options="options" @select="handleSelect">
                    <div class="flex-center-center bottom-right-button">
                        ...
                        <div style="transform: scale(0.85) translateY(3px); cursor: pointer; ">
            ...
            <div class="bottom-center">
                ...
                <div style="display: flex; align-items: center; justify-content: center;">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24"
                        ...
                        <g id="_Public/ic_public_play_last" stroke="none" stroke-width="1" fill="none"
                            fill-rule="evenodd">
            ...
            " @click="togglePlay">
                ...
                <div style="display: flex; align-items: center; justify-content: center;">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24"
                        ...
                        <g id="_Public/ic_public_play_next" stroke="none" stroke-width="1" fill="none"
                            fill-rule="evenodd">
                            <mask id="_mask-2" fill="white">
